 ...
 */
final class Version20260204082332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media_card (media_id INT NOT NULL, card_id INT NOT NULL, INDEX IDX_D5534700EA9FDD75 (media_id), INDEX IDX_D55347004ACC9A20 (card_id), PRIMARY KEY (media_id, card_id)) DEFAULT CHARACTER SET utf8mb4');
